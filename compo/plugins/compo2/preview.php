...
//			$ce = compo2_entry_load($params["cid"],intval($_REQUEST["uid"]));
	...
	if ( $has_embed ) {
		...
		$play_code = "<div id='embed' onclick='c2_play_game();'><img src='{$shot_url}'><div class='embed-overlay' width='{$width}' height='{$height}'></div><img class='embed-icon' src='/compo/wp-content/plugins/compo2/art/play.png' /></div>";
