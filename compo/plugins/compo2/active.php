...
//    
		...
		echo "<input type='checkbox' class='' name='' value='SETTING_NSFL'>My game contains material that may be offensive. Please include The Warning.<br /><strong>NOTE:</strong> We may enable this if we get complaints about a game. It's just a warning though.</input><br />";
