...
<?php
	...
	echo "<strong>TIP:</strong> Hosting on a Game website? <strong>Don't forget</strong> to link to your Ludum Dare page! They can't rate you if they can't find you!<br />";
	echo "<br />";
