...
function custom_login_message() {
	...
	//$message = '<p class="message">Registration/Login Problems? A bug with new user registrations was introduced earlier this week (fixed as of late-night Thursday). If you\'re unable to log in, resetting your password should fix it. If you still have problems, <a href="/compo/contact/">contact Mike</a>.</p>';
	return $message;
}
