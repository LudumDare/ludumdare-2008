...
//    
	...
	echo "If you don't set a thumbnail, Screenshot #1 will be used instead. <strong>TIP</strong>: If you use an exactly <strong>180x140 GIF</strong>, it will animate on hover. Max size 1 MB.<br />";
	echo "<span style='color:#F0F;'><strong>*WORK IN PROGRESS*</strong></span> This feature is unfinished. Come back later to set these.<br />";
	echo "<br />";
