...
//    
	...
	echo "If you don't set a thumbnail, Screenshot #1 will be used instead. <strong>TIP</strong>: If you use an exactly <strong>180x140 GIF</strong>, it will animate on hover.<br />";
	echo "<br />";
