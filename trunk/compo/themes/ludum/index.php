...
<?php } else { ?>
			<div class="post" id="post-<?php the_ID(); ?>" <?php if ( get_post_meta(get_the_ID(), '_liked', true) >= 4 ) { ?> style="background: #fff0f0 url('wp-content/themes/ludum/povimg/Heart.png') no-repeat top left;border: 1px solid #ff4444;"<?php } ?> >
<?php } ?>
