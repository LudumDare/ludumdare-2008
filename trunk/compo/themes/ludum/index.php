...
<?php if ( get_the_author_meta('display_name') == 'news' ) { ?>
			<div class="post" style="background: #f0fff0;border: 1px solid #c0ffc0;" id="post-<?php the_ID(); ?>">
<?php } else if ( get_the_author_meta('user_level') == 10 ) { ?>
			<div class="post" style="background: #fffff0;border: 1px solid #ffffc0;" id="post-<?php the_ID(); ?>">
<?php } else if ( is_sticky() ) { ?>
			<div class="post" style="background: #f7f0ff;border: 1px solid #e0c0ff;" id="post-<?php the_ID(); ?>">
<?php } else { ?>
			<div class="post" id="post-<?php the_ID(); ?>" <?php if ( get_post_meta(get_the_ID(), '_liked', true) >= 4 ) { ?> style="background: #fff0f0;border: 1px solid #ffd0d0;"<?php } ?> >
<?php } ?>
